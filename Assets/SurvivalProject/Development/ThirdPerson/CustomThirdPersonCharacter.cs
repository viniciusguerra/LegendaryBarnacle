...
namespace UnityStandardAssets.Characters.ThirdPerson
{
    ...
    public class CustomThirdPersonCharacter : MonoBehaviour
    {
        ...
        public static readonly string a_grounded = "Grounded";
        ...
        void UpdateAnimator(Vector3 move)
        {
            ...
            m_Animator.SetFloat(a_forwardSpeed, m_ForwardAmount, 0.1f, Time.deltaTime);
            m_Animator.SetFloat(a_turnSpeed, m_TurnAmount, 0.1f, Time.deltaTime);
